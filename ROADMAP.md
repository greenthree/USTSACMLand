...
- [ ] 每日一题、题目讨论和完成记录（公开 `/daily-problem` 与日期深链、匿名聚合数量、成员幂等完成记录与纯文本讨论、本人删除、管理员填写原因隐藏/恢复、后台题目草稿/发布/归档/删除、北京时间发布边界、乐观锁、限流、审计、注销级联与隐私说明均已实现；本地 Vitest、Lint、格式、生产构建、Chromium 深链/移动布局/axe 及 PGlite migration 烟测通过。2026-07-18 生产已应用第 46 个 migration，匿名 feed 返回 HTTP 200 且匿名完成写入返回 401。待 PostgreSQL 17 空库 CI、首题与成员/管理员完整烟测、Pages 发布验证通过后标记完成）。
