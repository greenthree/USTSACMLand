    ...
    <div className="page legal-page">
      ...
      <article className="legal-body">
        ...
        <section>
          <h2>公开范围</h2>
          <p>
            审核通过后，姓名、年级、专业、平台账号、Rating、通过题数和数据更新时间会显示在公开页面。邮箱、QQ、密码、登录令牌和后台审计详情不进入公开榜单。
          </p>
        </section>
        ...
        <section>
          <h2>修改与删除</h2>
          <p>
            成员可以在“我的资料”中更正资料和平台账号，关键信息变更可能重新进入审核。需要停用账号、删除资料或处理错误绑定时，请通过集训队内部渠道联系管理员。为保障安全和追踪管理操作，必要的审计记录及备份可能在业务数据删除后继续保留一段时间。
          </p>
        </section>
